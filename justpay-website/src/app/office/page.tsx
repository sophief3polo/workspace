      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[1480px] gap-6 px-4 py-4 lg:px-6 lg:py-6">
        <aside className="hidden w-[248px] shrink-0 flex-col rounded-[28px] border border-white/8 bg-[#0d0f14] p-4 lg:flex">
          ...
          <nav className="mt-6 space-y-1 text-sm text-[#98a2b3]">
            <a href="/" className="flex items-center justify-between rounded-xl px-3 py-2.5 transition hover:bg-white/[0.04] hover:text-white"><span>Overview</span></a>
            <a href="/calendar" className="flex items-center justify-between rounded-xl px-3 py-2.5 transition hover:bg-white/[0.04] hover:text-white"><span>Calendar</span></a>
            <a href="/projects" className="flex items-center justify-between rounded-xl px-3 py-2.5 transition hover:bg-white/[0.04] hover:text-white"><span>Projects</span></a>
            <a href="/memory" className="flex items-center justify-between rounded-xl px-3 py-2.5 transition hover:bg-white/[0.04] hover:text-white"><span>Memory</span></a>
            <a href="/docs" className="flex items-center justify-between rounded-xl px-3 py-2.5 transition hover:bg-white/[0.04] hover:text-white"><span>Docs</span></a>
            <a href="/team" className="flex items-center justify-between rounded-xl px-3 py-2.5 transition hover:bg-white/[0.04] hover:text-white"><span>Team</span></a>
            <a href="/office" className="flex items-center justify-between rounded-xl bg-white/[0.06] px-3 py-2.5 text-white transition"><span>Office</span><span className="h-2 w-2 rounded-full bg-[#1db38b]" /></a>
          </nav>
        </aside>
        ...
        <section className="flex min-h-[calc(100vh-2rem)] flex-1 flex-col rounded-[32px] border border-white/8 bg-[#0b0d12] shadow-[0_0_0_1px_rgba(255,255,255,0.02),0_40px_120px_rgba(0,0,0,0.45)]">
          ...
          <div className="flex-1 p-5 sm:p-6">
            <div className="grid gap-5 xl:grid-cols-[1.28fr_0.72fr]">
              <section className="rounded-[28px] border border-white/8 bg-[#0f1218] p-5">
                      ...
                      <div key={desk.name} className={`absolute ${desk.x} ${desk.y} w-[220px]`}>
                          ...
                          {desk.occupied ? (
                            <div className="absolute left-10 top-20">
                              <div className="relative h-16 w-12">
                                ...
                                <div className="absolute left-0 top-5 h-7 w-10 border-4 border-[#11151d] bg-[#1db38b]" />
                        ...
                        <div className="mt-32 rounded-2xl border border-white/8 bg-[#0d1016]/90 p-3">
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <span
                              className={`rounded-full border px-2.5 py-1 text-[11px] ${desk.occupied ? "border-emerald-400/20 bg-emerald-400/10 text-emerald-300" : "border-white/8 bg-white/[0.03] text-[#b3bbca]"}`}
                            >
                              {desk.state}
                            </span>
                          </div>
