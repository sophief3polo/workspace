        ...
        <section className="flex min-h-[calc(100vh-2rem)] flex-1 flex-col rounded-[32px] border border-white/8 bg-[#0b0d12] shadow-[0_0_0_1px_rgba(255,255,255,0.02),0_40px_120px_rgba(0,0,0,0.45)]">
          ...
          <div className="flex-1 p-5 sm:p-6">
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              {summary.map((item) => (
                <div key={item.label} className="rounded-[24px] border border-white/8 bg-[#0f1218] p-5">
              ...
              <section className="rounded-[28px] border border-white/8 bg-[radial-gradient(circle_at_top_left,rgba(94,106,210,0.2),transparent_34%),linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02))] p-6">
                ...
                <div className="mt-6 space-y-4">
                  {engagementMoments.map((item) => (
                    <article key={item.label} className="rounded-2xl border border-white/8 bg-[#0f1218]/80 p-4">
                      <div className="flex items-center justify-between gap-3">
                  ...
                  {posts.map((item) => (
                    <article key={item.title} className="rounded-2xl border border-white/8 bg-white/[0.02] p-4">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="min-w-[56px] rounded-2xl border border-white/8 bg-white/[0.04] px-3 py-2 text-center">
