                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="grid gap-4">
                    {projects.map((project) => (
                      <article key={project.name} className="rounded-[24px] border border-white/8 bg-[#232b3a]/92 p-5">
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                          ...
                          <div className="min-w-[180px] rounded-2xl border border-white/8 bg-white/[0.05] px-4 py-3">
                ...
                <div className="rounded-[28px] border border-white/8 bg-[#232b3a] p-6">
                  ...
                  <div className="mt-5 space-y-3">
                    {[
                      ...
                      <div key={item} className="flex items-center justify-between rounded-2xl border border-white/8 bg-white/[0.09] px-4 py-4">
